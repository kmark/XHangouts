...
public class MergedConversations {
    ...
    // This might stop working in Hangouts v14+
    private static final String HANGOUTS_MERGED_CONVERSATION = "fwj";
    private static final String HANGOUTS_MERGED_CONVERSATION_PARAM = "jyn";
