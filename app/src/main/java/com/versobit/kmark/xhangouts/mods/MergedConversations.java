...
public class MergedConversations {
    ...
    // This might stop working in Hangouts v15+
    private static final String HANGOUTS_MERGED_CONVERSATION = "fur";
    private static final String HANGOUTS_MERGED_CONVERSATION_PARAM = "jwi";
