...
public final class UiCallButtons {
    ...
    private static final String HANGOUTS_ENUM_CALL = "bwv";
    private static final String HANGOUTS_MENU_CALL = "cgi";
            ...
            findAndHookMethod(cMenuOptions, HANGOUTS_MENU_CALL_OPIS, MenuItem.class, new XC_MethodHook() {
                ...
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    ...
                    if (((MenuItem) param.args[0]).getItemId() == menuItemCallResId) {
                        ...
                        if (phoneNumber == null) {
                            // aQ = eht class (HANGOUTS_MENU_CALL class for ref)
                            Object altPhoneNumber = getObjectField(param.thisObject, "aQ");
                            if (altPhoneNumber != null) {
                                phoneNumber = (String) callMethod(altPhoneNumber, "c"); // method within eht
                            }
                        }
    ...
    private static void getNumber(XC_MethodHook.MethodHookParam param) {
        // j = cjp class (HANGOUTS_MENU_CALL class for ref)
        Object getPhoneNumber = getObjectField(param.thisObject, "j");
        phoneNumber = (String) callMethod(getPhoneNumber, "c"); // method within cjp
    }
