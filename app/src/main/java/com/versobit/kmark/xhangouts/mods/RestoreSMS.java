...
public class RestoreSMS {
    ...
    private static final String HANGOUTS_DEP_SMS_LIST = "ggv";
    private static final String HANGOUTS_DEP_SMS_CONV = "ggg";
    private static final String HANGOUTS_DEP_SMS_NOTI = "ggk";
