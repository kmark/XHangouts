...
public final class UiQuickSettings {
    ...
    private static final String HANGOUTS_NAV_MENUITEM_BASE = "dyy";
    private static final String HANGOUTS_NAV_MENUITEM_HELP = "dpr";

    private static final String HANGOUTS_MENU_POPULATOR = "jyn";
