...
public final class UiQuickSettings {
    ...
    private static final String HANGOUTS_NAV_MENUITEM_BASE = "dlf";
    private static final String HANGOUTS_NAV_MENUITEM_HELP = "dca";

    private static final String HANGOUTS_MENU_POPULATOR = "keo";
